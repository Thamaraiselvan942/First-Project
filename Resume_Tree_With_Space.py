...
def build_resume():
  ...
  #=========================================
  c2=Node("HSC")
  c2.add_child(Node("School:      Vaagai Vidhiyalaya Matric H.S.School"))
  c2.add_child(Node("Aggrigation: 86.5%"))
  c2.add_child(Node("Year:        2018"))
  #=========================================
  c3=Node("SSLC")
  c3.add_child(Node("School:      Vaagai Vidhiyalaya Matric H.S.School"))
  ...
  T.add_child(Node("Hardware: Arduino,RaspberryPi,IOT,Matlab"))
  #===============================================
